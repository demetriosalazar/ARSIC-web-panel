...
import { RegisterAp } from '../../../../../interfaces/RespApi';
import { MatSnackBar } from '@angular/material/snack-bar';
import { Router } from '@angular/router';

@Component({
  selector: 'app-registrar-ap',
  templateUrl: './registrar-ap.component.html',
  styleUrls: ['./registrar-ap.component.css']
})
export class RegistrarApComponent implements OnInit {
